...
class DetailsMap extends React.Component {
    ...
    constructor(props) {
        ...
        this.newdata = [],
            this.progressColor = ["#FF0000", "#f66565", "#f4c08c", "#FFFF00", "#7FFF00", "#00FF00", "#069806"];
        this.legendcount = 0
    ...
    changeColor = (layer, type) => {
        if (type == "Site Progress") {
            ...
            else if (layer.current_progress > 0 && layer.current_progress <= 20) {
                return this.progressColor[1];

            }
            else if (layer.current_progress > 20 && layer.current_progress <= 40) {
                return this.progressColor[2];

            }
            else if (layer.current_progress > 40 && layer.current_progress <= 60) {
                return this.progressColor[3];

            }
            else if (layer.current_progress > 60 && layer.current_progress <= 80) {
                return this.progressColor[4];

            }
            else if (layer.current_progress > 80 && layer.current_progress <= 99) {
        ...
        Axios.get(url)
            .then(response => {
                ...
                response.data.results.map((e) => {
                    ...
                    if (this.legendcount < 1) {
                        ...
                        legend.onAdd = (map) => {
                            ...
                            div.innerHTML +=
                                '<i class="circle_legend"  style="background:' + this.progressColor[0] + '"></i> ' +
                                '0%' + '<br>'
                            div.innerHTML +=
                                '<i class="circle_legend" style="background:' + this.progressColor[1] + '"></i> ' +
                                '0-20%' + '<br>'
                            div.innerHTML +=
                                '<i class="circle_legend" style="background:' + this.progressColor[2] + '"></i> ' +
                                '21-40%' + '<br>'
                            div.innerHTML +=
                                '<i class="circle_legend" style="background:' + this.progressColor[3] + '"></i> ' +
                                '41-60%' + '<br>'
                            div.innerHTML +=
                                '<i class="circle_legend" style="background:' + this.progressColor[4] + '"></i> ' +
                                '61-80%' + '<br>'
                            div.innerHTML +=
                                '<i class="circle_legend" style="background:' + this.progressColor[5] + '"></i> ' +
                                '81-99%' + '<br>'
                            div.innerHTML +=
                                '<i class="circle_legend" style="background:' + this.progressColor[6] + '"></i> ' +
                                '100%' + '<br>'
                ...
                if (response.data.next) {
                    ...
                    var a = document.getElementById('loadinginfoid').style.display = 'none';
    ...
    componentDidMount() {
        ...
        loadinginfo.onAdd = (map) => {
            ...
            div1.innerHTML += "<img src='../../static/images/loader1.gif'></img>"
